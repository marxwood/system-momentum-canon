...
- An authoritative reference for canonical structure
- A boundary definition for validity
- A constraint system for systems, institutions, and agents
...
It does not compel adoption.

Derivative artifacts may reference the Canon.
...
Misuse of the Canon can cause structural damage.

The Canon must not be used to:

- justify authority
- replace judgment
- legitimize outcomes

It exists to constrain, not to empower.
