...
- `governance/institutional-capture.md`

Governance applies only after canonical structure is understood.

---

## Status and Versions

Canonical state and versioning are defined in:

- `STATUS.md`
- `versions/`

Snapshots are read-only references.

---

## Interpretation Rules

- The Canon is read top-down.
- No document overrides a higher-level document.
- Later documents cannot redefine earlier ones.
- Absence of mention does not imply permission.
...
Any conflict must be resolved by canonical hierarchy, not by this index.
